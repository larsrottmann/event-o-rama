...
package com.eventorama.mobi.lib.location;
...
public interface LastLocationFinder {
   ...
   * @param minDistance Minimum distance before we require a location update in Meters
   * @param minTime Minimum time required between location updates in MS
